...
1. Install based Docker Documentation (http://docs.docker.com/engine/install/ubuntu/)
    ...
    - Intall Docker 
      ...
      F. cek installation -> sudo systemctl status docker
...
6. Push Projek Ke Github
   ...
   - Push Projek ke Github
    ...
    - git branch -M main
    - git remote add origin https://github.com/mohamadfirdaus0305-hue/compro_nim.git
